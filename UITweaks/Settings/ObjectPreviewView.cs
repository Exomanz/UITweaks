...
{ 
    [ViewDefinition("UITweaks.Settings.Views.preview.bsml")]
    //[HotReload(RelativePathToLayout = @"..\Settings\Views\preview.bsml")]
    public class ObjectPreviewView : BSMLAutomaticViewController
    {
